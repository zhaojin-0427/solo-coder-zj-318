...
const routes = [
  ...
  },
  {
    ...
    meta: { title: '人物线索管理', icon: 'Search', step: 2 }
  },
  {
    path: '/persons',
    name: 'Persons',
    component: () => import('@/views/PersonsPage.vue'),
    meta: { title: '人物关系补注', icon: 'User', step: 3 }
  },
  {
    path: '/memories',
    name: 'Memories',
    component: () => import('@/views/MemoriesPage.vue'),
    meta: { title: '回忆片段整理', icon: 'Document', step: 4 }
  },
  {
    path: '/confirm',
    name: 'Confirm',
    component: () => import('@/views/ConfirmPage.vue'),
    meta: { title: '家庭确认台', icon: 'CircleCheck', step: 5 }
  },
  {
    path: '/stats',
    name: 'Stats',
    component: () => import('@/views/StatsPage.vue'),
    meta: { title: '数据统计', icon: 'DataAnalysis', step: 6 }
  }
]
